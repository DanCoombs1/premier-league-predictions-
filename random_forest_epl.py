...
for team in epl_teams: #runs though all teams and counts up points, goals, wins etc for the season 
...
league_table.to_csv("League_table2223.csv") #saves data as a csv file
